	...
	<table style="text-align: left; margin-left: 35px;" cellspacing="5"
		...
		<tr>
			...
			<td><select class="field_select" id="merchantId"
				name="merchantId" value="${orderQuery.merchantId}"
				style="width: 170px; margin: 0px;">
			...
			<td><select class="field_select" id="catalogId" name="catalogId"
				value="${orderQuery.catalogId}" style="width: 170px; margin: 0px;">
			...
			<td><div id="date-begin1" class="input-append date form_date"
					...
					<input size="12" type="text" value="${orderQuery.startTime}" id="startTime"
			...
			<td><div id="date-begin2" class="input-append date form_date"
					...
					<input size="12" type="text" value="${orderQuery.endTime}" id="endTime"
...
<form id="cancelCfm" class="form-inline definewidth m20"
	...
	<input type="hidden" id="query1" name="query1" value="${orderQuery.orderId}" /> <input
		type="hidden" id="query2" name="query2" value="${orderQuery.merchantId}" /> <input
		type="hidden" id="query3" name="query3" value="${orderQuery.catalogId}" /> <input
		type="hidden" id="query4" name="query4" value="${orderQuery.orderStatus}" /> <input
		type="hidden" id="query5" name="query5" value="${orderQuery.productName}" /> <input
		type="hidden" id="query6" name="query6" value="${orderQuery.startTime}" /> <input
		type="hidden" id="query7" name="query7" value="${orderQuery.endTime}" /> <input
		type="hidden" id="query8" name="query8" value="${orderQuery.payType}" />
...
<table class="table table-bordered table-hover definewidth m10">
	<my:showUserInfoQuerysNew href="/manage/tab2/order/query.html"
		...
		query1="${orderQuery.orderId}" query2="${orderQuery.merchantId}" query3="${orderQuery.catalogId}"
		query4="${orderQuery.orderStatus}" query5="${orderQuery.productName}" query6="${orderQuery.startTime}"
		query7="${orderQuery.endTime}" query8="${orderQuery.payType}" />
</table>
<script>
 $(function(){
	 //对日期框进行控制
